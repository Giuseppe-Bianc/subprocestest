...
// configuration step. It creates a namespace called `subprocestest`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", subprocestest::cmake::project_name, subprocestest::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", subprocestest::cmake::project_version);
      return EXIT_SUCCESS;
    }
